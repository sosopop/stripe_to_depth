...
def validate_model(model, dataloader, criterion_depth, criterion_mask, device='cuda'):
    ...
    return avg_loss, avg_loss_depth, avg_loss_mask
...
if __name__ == '__main__':
    ...
    # 验证模型
    avg_loss, avg_loss_depth, avg_loss_mask = validate_model(generator_model, dataloader, criterion_depth, criterion_mask, device)
    print(f"Validation Loss: {avg_loss:.8f}, Depth Loss: {avg_loss_depth:.8f}, Mask Loss: {avg_loss_mask:.8f}")